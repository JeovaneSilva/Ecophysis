...
func _ready():
	...
	dialogue_data = [
		"Nerd:
		Ei cara! Toma cuidado",
			"Nerd: 
			Eles estão escondendo algo da
			gente. Eu sei...",
			"Nerd:
			Enfim, é perigoso prosseguir
			sozinho...",
			"Nerd:
				Leve is-... *hm hm*...
				empolguei, a regra é simples:",
				"Nerd:
					Pisa em cima dessas coisas e ta e elas 
					somem...",
					"Nerd:
						Não esqueça de recolher os lixos 
						que você encontrar...",
]
